...
final public class Constants {
    ...
    public final static String ADD_SHIFT_URL            = String.format("%s/%s", BASE_URL,
                                                                        ADD_SHIFT_ROUTE);
    public final static String ADD_WORKER_TO_SHIFT_ROUTE = SCHEDULE_ROUTE + "/addWorker";
    public final static String ADD_WORKER_TO_SHIFT_URL  = String.format("%s/%s", BASE_URL,
                                                                        ADD_WORKER_TO_SHIFT_ROUTE);
    public final static String GET_ALL_SHIFTS = SHIFT_ROUTE + "/test";
    public final static String ALL_SHIFTS_URL           = String.format("%s/%s", BASE_URL,
                                                                        GET_ALL_SHIFTS);
    public final static String GET_ALL_PROFILES = PROFILE_ROUTE + "/";
    public final static String ALL_PROFILES_URL         = String.format("%s/%s", BASE_URL,
                                                                        GET_ALL_PROFILES);
    public final static String GET_ALL_CONSTRAINTS    = CONSTRAINTS_ROUTE + "/";
    public final static String ALL_CONSTRAINTS_URL      = String.format("%s/%s", BASE_URL,
                                                                        GET_ALL_CONSTRAINTS);
    public final static String GET_ALL_SHIFT_REQUESTS = SHIFT_REQUESTS_ROUTE + "/";
    public final static String ALL_SHIFT_REQUESTS_URL   = String.format("%s/%s", BASE_URL,
                                                                        GET_ALL_SHIFT_REQUESTS);
    public final static String ADD_SHIFT_REQUESTS     = SHIFT_REQUESTS_ROUTE + "/";
    public final static String ADD_SHIFT_REQUEST_URL     = String.format("%s/%s", BASE_URL,
                                                                         ADD_SHIFT_REQUESTS);
    public static final String GET_SHIFTS_FROM_SCHEDULE    = SCHEDULE_ROUTE +
                                                             "/shifts_from_schedule";
    public final static String SHIFTS_FROM_SCHEDULE_URL = String.format("%s/%s", BASE_URL,
                                                                        GET_SHIFTS_FROM_SCHEDULE);
